...
from databricks.labs.migrator.hive_metastore.table_migration_status import TableMigrationIndex, TableView
from databricks.labs.migrator.hive_metastore.mapping import TableToMigrate
