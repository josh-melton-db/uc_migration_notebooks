...
def parse_logs(log: TextIO) -> Iterator[PartialLogRecord]:
    ...
    """
    time_format = "%H:%M:%S"
    # This regex matches the log format defined in databricks.labs.migrator.installer.logs.TaskLogger
...
class TaskLogger(contextlib.AbstractContextManager):
    ...
    def __init__(
        ...
        self._app_logger = logging.getLogger("databricks.labs.migrator")
