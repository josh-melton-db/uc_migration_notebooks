...
from databricks.labs.migrator.assessment.dashboards import Dashboard, DashboardOwnership
...
from databricks.labs.migrator.progress.install import Historical
