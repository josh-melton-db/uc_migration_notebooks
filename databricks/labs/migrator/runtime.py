...
from databricks.labs.migrator.assessment.workflows import Assessment, Failing
from databricks.labs.migrator.contexts.workflow_task import RuntimeContext
from databricks.labs.migrator.framework.tasks import Workflow, parse_args
from databricks.labs.migrator.installer.logs import TaskLogger
from databricks.labs.migrator.hive_metastore.workflows import (
    ScanTablesInMounts,
    TableMigration,
...
from databricks.labs.migrator.progress.workflows import MigrationProgress
from databricks.labs.migrator.recon.workflows import MigrationRecon
from databricks.labs.migrator.workspace_access.workflows import (
...
class Workflows:
    ...
    def trigger(self, *argv):
        ...
        with TaskLogger(
            ...
            ucx_logger = logging.getLogger("databricks.labs.migrator")
