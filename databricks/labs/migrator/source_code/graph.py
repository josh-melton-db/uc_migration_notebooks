...
from databricks.labs.migrator.source_code.python.python_ast import Tree
...
class DependencyGraph:
    ...
    def register_dependency(self, dependency: Dependency) -> MaybeGraph:
        ...
        # See databricks.labs.migrator.source_code.python_libraries.DistInfoContainer.build_dependency_graph for reference
