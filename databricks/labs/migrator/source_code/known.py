...
from databricks.labs.migrator.github import GITHUB_URL
from databricks.labs.migrator.hive_metastore.table_migration_status import TableMigrationIndex
from databricks.labs.migrator.source_code.base import Advice, CurrentSessionState
from databricks.labs.migrator.source_code.graph import (
    Dependency,
    DependencyLoader,
    StubContainer,
)
...
class KnownList:
    ...
    def _get_known() -> dict[str, dict[str, list[dict[str, str]]]]:
        ...
        if __name__ == "__main__":  # code path for UCX developers invoking `make known`
            module = "databricks.labs.migrator.source_code.known"
    ...
    def _analyze_file(cls, known_distributions, library_root, dist_info, module_path) -> None:
        ...
        from databricks.labs.migrator.source_code.files import FileLoader
