...
from databricks.labs.migrator.source_code.base import NOTEBOOK_HEADER
...
from databricks.labs.migrator.source_code.notebooks.magic import MagicNode, MagicCommand, magic_command_factory
