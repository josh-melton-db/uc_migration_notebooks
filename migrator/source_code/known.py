...
from migrator.github import GITHUB_URL
from migrator.hive_metastore.table_migration_status import TableMigrationIndex
from migrator.source_code.base import Advice, CurrentSessionState
from migrator.source_code.graph import (
    Dependency,
    DependencyLoader,
    StubContainer,
)
...
class KnownList:
    ...
    def _analyze_file(cls, known_distributions, library_root, dist_info, module_path) -> None:
        ...
        from migrator.source_code.files import FileLoader
