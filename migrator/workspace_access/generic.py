...
from migrator.workspace_access.base import AclSupport, Permissions, StaticListing
from migrator.workspace_access.groups import MigrationState
...
class WorkspaceListing(Listing, CrawlerBase[WorkspaceObjectInfo]):
    ...
    def _crawl(self) -> Iterable[WorkspaceObjectInfo]:
        ...
        from migrator.workspace_access.listing import WorkspaceListing
